...
clang++ -g -Wall -std=c++11 src/query.cpp src/utils/hash.cpp src/utils/random.cpp src/utils/misc.cpp src/utils/index.cpp src/utils/reads.cpp src/utils/bloom_io.cpp src/utils/kmer_io.cpp -o bin/query
